...
const ProjectTile = ({ name, logo, description, address, explorer, project_url, project_name, project_logo }: ProjectProps) => {
   return (
      <div key={name} className="flex flex-col overflow-hidden rounded-lg shadow-lg">
...
const ProjectArticle = ({ title, link, brief, cover }) => {
   return (
      <div key={title} className="flex flex-col lg:flex-row overflow-hidden rounded-lg shadow-lg flex-1">
         <div className="flex-shrink-0">
            ...
            <Container>
               <div className="py-10 flex flex-col gap-20">
                  <div className="w-full md:w-2/3 m-auto text-center">
                     <h1 className={"text-4xl font-bold text-center"}>We have Validators on the best projects!</h1>
                     <span className={"text-2xl"}>
                        We at Cosmoon are focused on creating and operating Validators, using the best hardware available in the
                        market, and studying the latest security system to create a worries-free experience.
                     </span>
                  </div>
